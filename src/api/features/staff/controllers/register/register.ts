      ...
      hashPassword(requestBody.password)
        .then(async (hashedPassword) => {
          ...
          if (foundStaff) {
            const conflictError = new ConflictError(
              "Staff username already exists, please choose another username"
            );
          ...
          staffModel
            .create({
              ...
              emergencyContact: {
                ...
                relationship:
                  requestBody.emergencyContact.relationship.toLowerCase(),
        ...
        .catch((error) => {
          ...
          sendFailureResponse({
            res,
            statusCode: 422,
            message: "There was a server error, not your fault, try again",
          });
        });
    })
    .catch((error) => {
      ...
      console.log(
        `VALIDATION ERROR: There was an error validating register staff request body`
      );
      console.log(error);
      sendFailureResponse({
        res,
